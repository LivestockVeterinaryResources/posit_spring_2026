...
source(file.path('functions/fxn_disease.R')) #functions to parse remarks and protocols

events_parsed<-read_parquet(file.path('data/intermediate_files/events_formatted.parquet'))
