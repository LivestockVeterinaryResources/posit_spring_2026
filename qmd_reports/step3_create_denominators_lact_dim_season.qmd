...
# save file
write_parquet(herd_deno, file.path('data/intermediate_files/herd_denominators.parquet'))
...
# save data
write_parquet(herd_deno_dim, file.path('data/intermediate_files/herd_dim_denominators.parquet'))
```
...
# save data
write_parquet(monthly_data, file.path('data/intermediate_files/herd_season_denominators.parquet'))
