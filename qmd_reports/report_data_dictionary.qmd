...
list_intermediate_files<-list.files(file.path('data/intermediate_files'))
...
calendar_options<-read_parquet(file.path('data/intermediate_files/denominator_by_calendar_time_period.parquet'))
