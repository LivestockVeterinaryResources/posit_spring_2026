...
source(file.path('functions/fxn_dt_base.R')) #functions to parse remarks and protocols
...
#*production_file <- file.path("data/intermediate_files/production_data/production.parquet")
...
```{r}
# Denominator files:
denos <-read_parquet(file.path('data/intermediate_files/herd_denominators.parquet'))

denos_dim <-read_parquet(file.path('data/intermediate_files/herd_dim_denominators.parquet'))

denos_season <- read_parquet(file.path('data/intermediate_files/herd_season_denominators.parquet'))
```
