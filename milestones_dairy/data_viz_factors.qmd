...
events_formatted_all <- read_parquet(file.path('data/intermediate_files/events_all_columns.parquet')) |>
  select(source_file_path, ID, BDAT, FDAT, LACT, ARDAT, Event, Date, 
         Protocols, Remark, R, T, B)  

         
source(file.path('functions/fxn_milestone7_solution.R'))
...
file_path <- file.path("milestones_dairy/images/milestone_7.htm")
