...
solution<-read_rds(file.path('milestones_dairy/data_milestones/solutions_week_05_pivotlonger.rds'))
...
denominator_base<-read_parquet(file.path('data/intermediate_files/denominator_by_calendar_time_period.parquet'))
events_formatted <- read_parquet(file.path('data/intermediate_files/events_formatted.parquet'))
...
denominator<-read_parquet(file.path('data/intermediate_files/denominator_by_calendar_time_period.parquet'))%>%
...
mast_event_summary<-read_parquet(file.path('data/intermediate_files/events_formatted.parquet'))%>%
