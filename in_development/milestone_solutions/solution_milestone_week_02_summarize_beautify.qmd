...
write_rds(check, file.path('milestones_dairy/data_milestones/solutions_week_03_check_columns.rds'))

waldo::compare(check, read_rds(file.path('milestones_dairy/data_milestones/solutions_week_03_check_columns.rds')))
...
write_rds(dim_at_bred, file.path('milestones_dairy/data_milestones/solutions_week_03_summary_data.rds'))

solution <- readr::read_rds(file.path('milestones_dairy/data_milestones/solutions_week_03_summary_data.rds'))
solution
