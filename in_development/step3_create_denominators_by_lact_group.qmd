...
write_parquet(denominator_granular, file.path('data/intermediate_files/denominator_granular.parquet'))
...
write_parquet(denominator_time_period, file.path('data/intermediate_files/denominator_by_lact_group.parquet'))
