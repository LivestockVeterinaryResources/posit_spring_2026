...
disease_animal_long<-read_parquet(file.path('data/intermediate_files/disease_animal_level_long.parquet'))

disease_lact_long<-read_parquet(file.path('data/intermediate_files/disease_lactation_level_long.parquet'))

#numerator base files long ---------each row is a an animal or animal lact with diseases in wide format
disease_animal_wide<-read_parquet(file.path('data/intermediate_files/disease_animal_level_wide.parquet'))

disease_lact_wide<-read_parquet(file.path('data/intermediate_files/disease_lactation_level_wide.parquet'))
...
test_animal<-read_parquet(file.path('data/intermediate_files/events_formatted.parquet'))%>%
  filter(id_animal %in% '15584_09/08/12')

check_fresh<-read_parquet(file.path('data/intermediate_files/events_formatted.parquet'))%>%
  filter(event %in% 'FRESH')%>%
  mutate(floordate_month = floor_date(date_event, unit = 'month'))

check_left<-read_parquet(file.path('data/intermediate_files/events_formatted.parquet'))%>%
...
write_parquet(denominator_granular, file.path('data/intermediate_files/denominator_granular_by_DIM_group.parquet'))
...
write_parquet(denominator_time_period, file.path('data/intermediate_files/denominator_by_DIM_group.parquet'))
