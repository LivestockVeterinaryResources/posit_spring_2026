...
events_parsed<-read_parquet(file.path('data/intermediate_files/events_parsed.parquet'))
...
write_parquet(disease_animal_level_long, file.path('data/intermediate_files/disease_animal_level_long.parquet'))
...
write_parquet(disease_lactation_level_long, file.path('data/intermediate_files/disease_lactation_level_long.parquet'))
...
write_parquet(master_disease_animal_level_wide, file.path('data/intermediate_files/disease_animal_level_wide.parquet'))
...
write_parquet(master_disease_lactation_level_wide, file.path('data/intermediate_files/disease_lactation_level_wide.parquet'))
